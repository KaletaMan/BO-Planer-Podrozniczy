...
% ── Wykresy pgfplots (natywne, wektorowe) ────────────────────────────────────
\usepackage{pgfplots}
\pgfplotsset{compat=1.17}
\usepgfplotslibrary{statistics,fillbetween}

\definecolor{abcblue}{RGB}{31,119,180}
\definecolor{beeorange}{RGB}{255,127,14}
\definecolor{seedA}{RGB}{31,119,180}
\definecolor{seedB}{RGB}{255,127,14}
\definecolor{seedC}{RGB}{44,160,44}
\definecolor{seedD}{RGB}{214,39,40}
\definecolor{seedE}{RGB}{148,103,189}

% Wspolny styl wykresow eksperymentow
\pgfplotsset{
    wykres/.style={
        width=0.85\textwidth,
        height=6.8cm,
        ...
        tick style={gray!70},
        tick label style={font=\footnotesize, /pgf/number format/1000 sep={}},
...
% Polskie nazwy odsyłaczy (cleveref nie ma wbudowanego języka polskiego).
% Skróty omijają problem odmiany przez przypadki ("w tab. 2", "na rys. 1").
...
% ═════════════════════════════════════════════════════════════════════════════
\input{sekcje/01_wstep}
\input{sekcje/02_opis_zagadnienia}
\input{sekcje/03_opis_algorytmow}
\input{sekcje/04_aplikacja}
\input{sekcje/05_eksperymenty}
\input{sekcje/06_podsumowanie}
\input{sekcje/07_literatura}
\input{sekcje/08_dodatek}
